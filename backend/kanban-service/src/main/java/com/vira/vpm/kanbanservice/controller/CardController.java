...
public class CardController {
    ...
    @PostMapping
    public ResponseEntity<CardDto> createFromBoard(@RequestBody CreateCardDto data)
    ...
    public ResponseEntity<List<CardDto>> sortCardsAndColumns(@RequestBody List<CardDto> data)
